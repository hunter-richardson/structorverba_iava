...
import net.structorverba.bibliotheca.verba.multiplicia.Prōnōmen;
...
public final class InventorPrōnōminibus extends Inventor <Prōnōmen> {
  ...
  /**
   * @return Quaestiōnem quam rēs classis {@link LēctorMultiplicibus .LēctorPrōnōminibus} ūtātur rēs classis {@link
   *   Prōnōmen} percōlere
