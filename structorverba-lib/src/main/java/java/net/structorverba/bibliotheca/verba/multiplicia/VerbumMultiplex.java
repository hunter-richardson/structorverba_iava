...
import net.structorverba.bibliotheca.conditores.multiplicia.ConditōrMultiplicibus;
import net.structorverba.bibliotheca.inventores.Inventor;
...
import net.structorverba.bibliotheca.verba.*;
 ...
 * Inventor} rēbus classis huius adsunt ūtilissimaeque sunt rēs classis huius percōlere. <br> Discrīmina prīmōria inter
 * classibus hāc classeque {@link VerbumSimplex} sunt huius valōrēs {@link #scrīptiō}que {@link #encliticum}que.
...
public abstract class VerbumMultiplex <Hoc extends Verbum <Hoc>> extends Verbum <Hoc> {
  ...
  @NotNull public VerbumMultiplex <Hoc> allegō(@NotNull final Encliticum cltm) {
    encliticum = Stream.of(Encliticum.values())
                       .anyMatch(e -> lemma.endsWith(e.scrīptiō)) ? Encliticum.NŌLĒNS
                                                                  : cltm;
    return this;
  }
