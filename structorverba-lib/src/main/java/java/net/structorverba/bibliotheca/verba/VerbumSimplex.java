package net.structorverba.bibliotheca.verba;
...
import net.structorverba.bibliotheca.lectores.LēctorPraepositiōnibus;
import net.structorverba.bibliotheca.lectores.LēctorSimplicibus;
import net.structorverba.bibliotheca.miscella.Ūtilitās;
import net.structorverba.bibliotheca.nuntii.Nūntius;
import net.structorverba.bibliotheca.tenores.TenorSimplicibus;
import net.structorverba.bibliotheca.enumerationes.Catēgoria;
