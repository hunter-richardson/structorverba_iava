package net.structorverba.bibliothēca.inventōrēs;

import net.structorverba.lēctōrēs.LēctorMultiplicibus;
import net.structorverba.nūntiī.Nūntius;
import net.structorverba.verba.multiplicia.Adverbium;
import net.structorverba.ēnumerātiōnēs.Gradus;
